...
static std::tuple<std::string_view, std::function<aimrt::ModuleBase*()>>
    aimrt_module_register_array[]{
        {"ExecutorModule",
         []() -> aimrt::ModuleBase* {
           return new Logger::executor_module::ExecutorModule();
         }},
        {"ExecutorCoModule",
         []() -> aimrt::ModuleBase* {
           return new Logger::executor_co_module::ExecutorCoModule();
         }},
        {"ExecutorCoLoopModule",
         []() -> aimrt::ModuleBase* {
           return new Logger::executor_co_loop_module::ExecutorCoLoopModule();
         }},
        {"RealTimeModule",
         []() -> aimrt::ModuleBase* {
           return new Logger::real_time_module::RealTimeModule();
         }},
    };
