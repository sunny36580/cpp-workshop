...
cmake -S "$RUNTIME_DIR" -B "$BUILD_DIR/runtime" -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE:-Release}
cmake --build "$BUILD_DIR/runtime" -j"$(nproc)"
echo "[1/2] runtime → $BUILD_DIR/runtime/robot"
...
echo "=========================================="
echo " Build complete!"
echo "  runtime:  $BUILD_DIR/runtime/robot"
